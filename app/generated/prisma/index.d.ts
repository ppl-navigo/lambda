...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "order" | "payment" | "balance" | "limit"
  ...
  export type LimitSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    limit_id?: boolean
    user_id?: boolean
    generate_limit?: boolean
    analyze_limit?: boolean
    chat_limit?: boolean
    chat_last_used_at?: boolean
  ...
  export type LimitOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"limit_id" | "user_id" | "generate_limit" | "analyze_limit" | "chat_limit" | "chat_last_used_at", ExtArgs["result"]["limit"]>
  ...
  export interface LimitDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `limit_id`
     * const limitWithLimit_idOnly = await prisma.limit.findMany({ select: { limit_id: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Limits and only return the `limit_id`
     * const limitWithLimit_idOnly = await prisma.limit.createManyAndReturn({
     *   select: { limit_id: true },
     *   data: [
     *     // ... provide data here
     *   ]
     * })
     ...
     * })
     * 
     * // Update zero or more Limits and only return the `limit_id`
     * const limitWithLimit_idOnly = await prisma.limit.updateManyAndReturn({
     *   select: { limit_id: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface LimitFieldRefs {
    readonly limit_id: FieldRef<"Limit", 'String'>
    readonly user_id: FieldRef<"Limit", 'String'>
    readonly generate_limit: FieldRef<"Limit", 'Int'>
    readonly analyze_limit: FieldRef<"Limit", 'Int'>
    readonly chat_limit: FieldRef<"Limit", 'Int'>
    readonly chat_last_used_at: FieldRef<"Limit", 'DateTime'>
  }
  ...
  export type LimitWhereInput = {
    ...
    limit_id?: StringFilter<"Limit"> | string
    user_id?: StringFilter<"Limit"> | string
    generate_limit?: IntFilter<"Limit"> | number
    analyze_limit?: IntFilter<"Limit"> | number
    chat_limit?: IntFilter<"Limit"> | number
    chat_last_used_at?: DateTimeNullableFilter<"Limit"> | Date | string | null
  }

  export type LimitOrderByWithRelationInput = {
    limit_id?: SortOrder
    user_id?: SortOrder
    generate_limit?: SortOrder
    analyze_limit?: SortOrder
    chat_limit?: SortOrder
    chat_last_used_at?: SortOrderInput | SortOrder
  }
  ...
  export type LimitScalarWhereWithAggregatesInput = {
    ...
    limit_id?: StringWithAggregatesFilter<"Limit"> | string
    user_id?: StringWithAggregatesFilter<"Limit"> | string
    generate_limit?: IntWithAggregatesFilter<"Limit"> | number
    analyze_limit?: IntWithAggregatesFilter<"Limit"> | number
    chat_limit?: IntWithAggregatesFilter<"Limit"> | number
    chat_last_used_at?: DateTimeNullableWithAggregatesFilter<"Limit"> | Date | string | null
  }
  ...
  export type LimitCreateInput = {
    ...
    analyze_limit?: number
    chat_limit?: number
    chat_last_used_at?: Date | string | null
  }
  ...
  export type LimitUpdateInput = {
    limit_id?: StringFieldUpdateOperationsInput | string
    user_id?: StringFieldUpdateOperationsInput | string
    generate_limit?: IntFieldUpdateOperationsInput | number
    analyze_limit?: IntFieldUpdateOperationsInput | number
    chat_limit?: IntFieldUpdateOperationsInput | number
    chat_last_used_at?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
  }
